...
def _attach_source_candidate_coordinates(
    ...
    """Attach explicit canonical and source coordinates to candidate diagnostics.

    The low-level parser works in a straightened canonical column band. Older
    cache versions mislabeled that reading-axis V as source_y. Normalize it
    here before diagnostics leave the OCR pipeline.
    """
