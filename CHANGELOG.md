...
- 主界面【六、页面列表】固定栏顺序调整为“书签 / 页面 / 画线 / 插图 / 填充状态”；项目初次载入、行刷新、排序映射和右键列菜单同步使用同一顺序，避免仅换表头造成数据错列。
- 新增统一【选择字体…】窗口：字体族、字形（常规 / 粗体 / 斜体 / 粗斜体）和字号集中选择，并提供实时示例预览；主界面词条字体、插图标签字体、校对词条字体、简体字体以及设置中心均复用同一选择器。底层仍保存原有 family / size / bold / italic 字段，旧项目配置继续兼容。
